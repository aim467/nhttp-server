...
class FileUploader {
    ...
    resetModal() {
        ...
        this.isUploading = false;
        this.updateFileList();
        this.uploadProgress.classList.remove('is-visible');
    ...
    updateFileList() {
        if (this.files.length === 0) {
            this.uploadFileList.classList.remove('is-visible');
            this.startUploadBtn.disabled = true;
            return;
        }

        this.uploadFileList.classList.add('is-visible');
    ...
    async startUpload() {
        ...
        this.startUploadBtn.disabled = true;
        this.uploadProgress.classList.add('is-visible');
                ...
                if (xhr.status === 200) {
                    ...
                    if (response.success) {
                        ...
                        if (window.windowsExplorer) {
                            window.windowsExplorer.refreshDirectory({ silent: true })
